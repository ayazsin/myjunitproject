...
//                sendKeys("testtechproed@gmail.com"); //typing in the element
        ...
        System.out.println(userId);//[[ChromeDriver: chrome on MAC (cd9426bb1e1e642b40157e4dff29af6a)] -> class name: navbar-text]

        //getText(); return the test of the webelements. Return typr is a String.
...
//        String userIdText = driver.findElement(By.className("navbar-text")).getText();
        ...
        WebElement signOutElement = driver.findElement(By.partialLinkText("ign out"));//Will find Sign
//        WebElement signOutElement = driver.findElement(By.partialLinkText("gn out"));
        ...
        //Links are created by a tag, so we can find all links b finding all elements with atag
        ...
        //Verify the sign out is succesful
